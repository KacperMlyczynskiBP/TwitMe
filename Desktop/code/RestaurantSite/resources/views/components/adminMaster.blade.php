...
<div id="pgside">
    ...
    <!-- (A2) MENU ITEMS -->
    <a href="{{ route('showEditFood') }}" class="current">
        <i class="ico">&#9733;</i>
        Food
    </a>
    <a href="{{ route('renderDishType') }}">
        <i class="ico">&#9728;</i>
        <i class="txt">Category</i>
    </a>
    <a href="{{ route('showEditTable') }}">
        <i class="ico">&#9737;</i>
        <i class="txt">Tables</i>
    </a>
    <a href="">
        <i class="ico">&#9737;</i>
        <i class="txt">Discounts</i>
    </a>
    <a href="{{ route('showAdminReservation') }}">
        <i class="ico">&#9737;</i>
        <i class="txt">All Booking</i>
    </a>
    <a href="#">
        <i class="ico">&#9737;</i>
        <i class="txt">All Orders</i>
    </a>
</div>
